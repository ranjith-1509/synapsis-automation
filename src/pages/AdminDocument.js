...
import DataSource from "../JSON/adminDocument.json";
      ...
      <div className="max-w-7xl  h-full mx-auto  sm:px-6 lg:px-8 " style={{ marginLeft: "200px" }}>
        ...
        >
          ...
          <div className="p-6 flex justify-between items-center border-b border-gray-200">
            <div>
              <h1 className="text-lg font-semibold text-gray-900">Admin Document</h1>
                      ...
                      return (
                        <div className="flex gap-1" style={{ cursor: "pointer" }}>
                          {tagsArray.map((tag, idx) => (
                            <span key={idx} className="text-[14px] font-normal text-[#667085]">
                              {tag}
                            </span>
                          ))}
                        </div>
